...
export default function Navigation() {
    return (
        <Disclosure as="nav" className="bg-white/50 mx-4 my-4 rounded-xl">
            {({ open }) => (
                <>
                            ...
                            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                                <div className="flex-shrink-0 flex items-center">
                                    <div className="block lg:hidden h-8 w-auto">
                                        <Image src="/apw-text-transparent-color.png" alt="Vercel Logo" width={200} height={48.59} />
                                    </div>
                                    <div className="hidden lg:block  w-auto">
                                        <Image src="/apw-text-transparent-color.png" alt="Vercel Logo" width={175} height={42} />
                                    </div>
                                </div>
                                <div className="hidden sm:block sm:ml-6 pt-2">
